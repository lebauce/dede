...
_DedeFakeMouse = function() {
  ...
  sheet.insertRule('#dede-fake-mouse-pointer {position:absolute; z-index:9999999; width:19px; height:32px; background-image: ' + img + ';}', sheet.cssRules ? sheet.cssRules.length : 0);
